    ...
    def build_arch(self):
        ...
        if self.reconstruction:
            ...
            with tf.variable_scope('Decoder'):
                masked_caps = tf.multiply(self.digitCaps, tf.reshape(self.one_hot_labels, (-1, self.num_label, 1, 1)))
                ...
                self.decoded = tf.layers.dense(fc2, num_outputs=self.height * self.width * self.channels,
