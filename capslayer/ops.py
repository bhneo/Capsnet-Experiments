...
def routing_thibo(u_hat, b_ij, nb_capsules, nb_capsules_p, iterations=4):
    """
        Routing algorithm
...
def dynamic_routing(input, b_IJ, iter_routing=3, stddev=0.1):
